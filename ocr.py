...
def main():
    ...
    askfilebutton=ttk.Button(root, text="Alege imagine cu buletinul", image=photoImg_choose, compound=LEFT, command=partial(validate.show_file_chooser,root))
    ...
    asktemplate=ttk.Button(root,text="Alege documentul de completat", image=photoImg_template, compound=LEFT,command=partial(cereri.selecteaza_documente,root))
